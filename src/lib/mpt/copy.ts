...
export const copy = {
  ...
  apply: {
    ...
    examInProgress: (minutes: number) => `Exam in progress — ${minutes} min left to apply and enter`,
  ...
  entrance: {
    ...
    label: 'Enter your 6-digit Roll Number',
    hint: 'Your Roll Number is on your My CSS Vista dashboard.',
    submit: 'Verify & Enter',
    verifying: 'Verifying…',
    where: 'Where is my Roll Number?',
    typo: 'Please check your Roll Number — one digit looks wrong.',
  ...
  result: {
    ...
    pending: (time: string) => `Submitted. Your result will be available at ${time}.`,
  ...
  dashboard: {
    ...
    viewResult: 'View Detailed Result',
