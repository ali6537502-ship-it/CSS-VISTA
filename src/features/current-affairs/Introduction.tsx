...
export default function Introduction() {
  ...
  return <div className="ca-intro">
    <header className="ca-intro-hero"><p className="ca-eyebrow">CSS VISTA · CURRENT AFFAIRS</p><h1>Understand the day.<br />Remember what matters.</h1>
      <p className="ca-intro-lead">CSS Vista Current Affairs is a focused current-affairs reading desk: clear explanations, revision facts, important statistics and original sources, together in your free CSS Vista account.</p>
