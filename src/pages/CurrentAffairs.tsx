  ...
  return (
    <div>
      ...
      <main className="mx-auto max-w-6xl px-4 py-8">
        <section className="mb-6 flex flex-wrap items-center justify-between gap-4 rounded-xl border border-emerald-200 bg-emerald-50/60 p-5"><div><h2 className="text-lg font-bold text-pine">Your Daily Current Affairs Briefing</h2><p className="mt-1 text-sm text-muted-foreground">Explanations, revision facts, original sources and saved reading in one free account.</p></div><Link to="/daily-briefing" className="inline-flex min-h-11 items-center rounded-md bg-pine px-4 text-sm font-semibold text-white">Explore the daily dashboard</Link></section>
