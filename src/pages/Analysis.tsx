...
// Every "what to do instead" names a tool that already exists on the site, and
// the page linked to none of them.
interface AnalysisTool { label: string; to: string }

const analyses: { title: string; causes: string[]; fixes: string[]; tools: AnalysisTool[] }[] = [
  {
