...
export function PrivacyPolicy() {
  return (
    <Shell title="Privacy Policy" description="How CSS Vista handles account, study-progress, security, advertising and browser-storage data.">
      ...
      <section><H2>International processing</H2><p>Some service providers, including Google and Hostinger, operate infrastructure in multiple countries. Information handled by those providers may therefore be processed outside Pakistan under their applicable contractual and legal arrangements.</p></section>
...
export function CookiePolicy() {
  return (
    <Shell title="Cookie Policy" description="The cookies, local storage and session storage currently used by CSS Vista and its advertising services.">
      ...
      <section><H2>Advertising cookies and identifiers</H2><p>Eligible public content pages can load Google AdSense. Google and its advertising partners may place or read cookies, use web beacons, IP addresses or similar identifiers for ad delivery, measurement, fraud prevention and, where permitted by the user's choices and applicable rules, personalization. These are third-party advertising technologies controlled by the relevant provider rather than CSS Vista's first-party session system. Their exact names and lifetimes can change as Google updates its services, so this policy does not invent a fixed cookie-name list.</p></section>
