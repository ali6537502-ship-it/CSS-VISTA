...
export const ROUTE_REGISTRY = [
  ...
  protectedPage('/subjects/selector', 'CSS Subject Selection Tool', 'Interactive CSS optional-subject selection tool.'),
  ...
  publicPage('/past-papers', 'CSS, PMS and PPSC Past Papers', 'Browse downloadable CSS, PMS, PPSC and MPT past papers organised by examination, year and subject.', 'Competitive examination past papers'),
  ...
  protectedPage('/css-mcqs', 'CSS Subject MCQs', 'Interactive CSS subject question-bank practice.'),
  protectedPage('/essay', 'CSS Essay Preparation', 'Interactive CSS essay preparation and mentoring resources.'),
  ...
  protectedPage('/answer-writing', 'Answer-Writing Practice', 'Interactive CSS answer-writing practice.'),
  protectedPage('/test-series', 'Customized Test Series', 'Customized written test-series workflow.'),
  protectedPage('/study-tools', 'CSS Study Tools', 'Interactive study tools for CSS aspirants.'),
  protectedPage('/games', 'Interactive Practice', 'Academic matching activities and interactive practice.'),
  ...
  protectedPage('/grammar-vocabulary', 'Grammar and Vocabulary Practice', 'Interactive grammar, vocabulary and daily question practice.'),
  ...
  protectedPage('/gk/cat/:slug', 'GK Question Bank', 'Interactive general-knowledge question-bank practice.', { match: 'pattern' }),
  ...
  protectedPage('/answer-timer', 'Answer Timer', 'Interactive answer-writing timer.'),
  ...
  protectedPage('/privacy', 'Privacy and Advertising', 'Read CSS Vista privacy, advertising and cookie information.'),
