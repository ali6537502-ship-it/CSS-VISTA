...
export const ROUTE_REGISTRY = [
  ...
  publicPage('/book-summaries', '100 Book Summaries for CSS Aspirants', 'Browse searchable book summaries and reading guidance for CSS and competitive-examination preparation.', 'Book summaries for CSS aspirants', { contentQuality: 'utility', adMode: 'enabled' }),
  ...
  publicPage('/opinions', 'CSS Vista Opinions and Analysis', 'Read long-form opinions and analysis relevant to CSS preparation.', 'CSS Vista opinions and analysis', { contentQuality: 'substantial', adMode: 'enabled' }),
