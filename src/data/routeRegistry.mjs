...
export const ROUTE_REGISTRY = [
  ...
  publicPage('/daily-briefing', 'CSS Vista Daily Affairs Brief', 'Read the daily CSS Vista Current Affairs brief with explanations, sourced facts, statistics, archives and personal bookmarks.', 'Understand the day. Remember what matters.', { adMode: 'none', minimumHeight: 0 }),
  ...
  protectedPage('/account/current-affairs', 'Daily Affairs Brief', 'Your protected CSS Vista Current Affairs daily edition.', { robots: 'noindex, nofollow' }),
  protectedPage('/account/current-affairs/archive', 'Daily Affairs Archive', 'Browse protected Daily Affairs Brief editions by date and topic.', { robots: 'noindex, nofollow' }),
