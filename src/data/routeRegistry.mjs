...
export const ROUTE_REGISTRY = [
  ...
  publicPage('/explore', 'Explore CSS Vista', 'A complete directory of every CSS Vista resource, grouped by what you are trying to do.', 'Everything on CSS Vista'),
  ...
  publicPage('/daily-briefing', 'Daily Current Affairs Dashboard', 'A free CSS Vista account for daily current affairs explanations, sourced facts, statistics, archives and personal bookmarks.', 'Understand the day. Remember what matters.', { adMode: 'none', minimumHeight: 0 }),
  protectedPage('/account/dashboard', 'My Daily Briefing', 'Your personal current affairs reading desk.', { robots: 'noindex, nofollow' }),
  protectedPage('/account/current-affairs', 'Daily Current Affairs', 'Your protected daily current affairs briefing.', { robots: 'noindex, nofollow' }),
  protectedPage('/account/current-affairs/archive', 'Current Affairs Archive', 'Browse protected daily editions by date and topic.', { robots: 'noindex, nofollow' }),
  ...
  protectedPage('/account/saved', 'Saved Developments', 'Your private saved reading.', { robots: 'noindex, nofollow' }),
  protectedPage('/account/search', 'Search Current Affairs', 'Search the protected current affairs archive.', { robots: 'noindex, nofollow' }),
  protectedPage('/account/settings', 'Account Settings', 'Manage your reading preferences and account.', { robots: 'noindex, nofollow' }),
