...
export const ROUTE_REGISTRY = [
  ...
  publicPage('/vistagram', 'CSS Vistagram — Concepts, Articles and Explainers', 'Explore the public CSS Vistagram learning feed with concepts, articles, explainers, data, case studies and exam-relevant ideas.', 'CSS Vistagram', { contentQuality: 'substantial', adMode: 'enabled' }),
  publicPage('/vistagram/:slug', 'CSS Vistagram Article', 'Read a complete CSS Vistagram concept, article or explainer with sources and related learning material.', 'CSS Vistagram article', { contentQuality: 'substantial', adMode: 'enabled', match: 'pattern', schemaType: 'Article' }),
