...
export const libraryItems: LibraryItem[] = [
  ...
  { id: 'lib8', title: 'CSS Past Papers - Owner files pending', subject: 'All subjects', topic: 'Past papers', type: 'Past Paper', description: 'The past-paper archive activates when the owner uploads the official collected papers. Metadata (year, subject, topic, repeated themes) will be extracted then.', author: '-', source: 'Owner-provided', tags: ['past papers'], lastUpdated: '2026-07-17', status: 'awaiting-owner-file' },
