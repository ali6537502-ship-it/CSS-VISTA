...
export const compulsoryLectureCourses: LectureCourse[] = compulsorySubjects.map((subject) => ({
  slug: subject.slug,
  title: subject.name,
  kind: 'Compulsory',
  marks: subject.marks,
...
export const lectureCourses = [...compulsoryLectureCourses, ...optionalLectureCourses]

export const lectureSyllabusSource = {
