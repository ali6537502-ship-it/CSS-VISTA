...
if (process.argv.includes('--artifact')) {
  ...
  assert(sample.includes('Past Paper pages contain only the owner-provided watermarked PDF'), 'Direct paper HTML must describe the watermarked-PDF-only policy')
