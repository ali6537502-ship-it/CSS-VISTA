...
/* This body deliberately carries no general study advice. The same three
   sentences on all 782 paper pages left most of each page identical to the
   others; the enrichment step that follows adds guidance assembled from each
   paper's own record instead. */
...
homeHtml = replaceSearchMeta(homeHtml, {
  ...
  description: 'CSS Vista is a free CSS, PMS and one-paper competitive exam preparation platform in Pakistan with MCQs, past papers, notes, current affairs and study tools.',
