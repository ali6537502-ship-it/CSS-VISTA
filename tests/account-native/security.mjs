...
const profilePhoto = new FormData(); profilePhoto.append('photo',new Blob([Buffer.from('','base64')],{type:'image/jpeg'}),'test-only.jpg')
...
console.log('PASS: native registration, email verification, password recovery, single-use tokens, old-session revocation, password change, cookie security, all 12 mandatory profile checks plus mentor-history validation and unlock/relock, private factbook CRUD/search/revisions/media/collections, cross-user isolation, rollback, owner CMS and persistence.')
