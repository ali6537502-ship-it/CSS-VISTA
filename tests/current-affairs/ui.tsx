...
const fixtureUser = { id: 'a1111111-1111-4111-8111-111111111111', email: 'test-reader@example.invalid', user_metadata: { full_name: 'Test Reader' } } as User
function Review() {
  ...
  return <AccountContext.Provider value={{ configured: true, loading: false, user, passwordRecovery: false, syncStatus: 'idle', syncBackend: null, syncError: '', lastSyncedAt: null,
    signIn: unavailable, signUp: unavailable, signInWithGoogle: unavailable, requestPasswordReset: unavailable, updatePassword: unavailable,
